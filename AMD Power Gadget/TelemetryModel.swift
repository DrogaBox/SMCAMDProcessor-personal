...
// MARK: - Performance Optimization: Threshold-Based Property Wrapper

/// PropertyWrapper que solo publica cambios cuando superan un threshold
/// Esto evita redraws innecesarios en la UI para valores que cambian constantemente
@propertyWrapper
